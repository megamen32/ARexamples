...
public class ArClientCloudAnchorController : ArClientBaseController
{
    ...
    {
        base.Update();
        if (netClient == null || !clientConnected) return;
        if (marManager == null || !marManager.IsTracking()) return;
                ...
                marManager.RestoreWorldAnchor(worldAnchorId, (anchorObj, errorMessage) =>
                                                             {
                                                                 ...
                                                                 } else
                                                                 {
                                                                     ...
                                                                     GetGameAnchorRequestMsg request = new GetGameAnchorRequestMsg {gameName = this.gameName};
